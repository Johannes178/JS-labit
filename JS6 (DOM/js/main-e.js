...
for (let n = 0; n < picArray.length; n++){
  ...
  image.src = picArray[n].filename;
  image.alt = picArray[n].caption;
  figcaption.innerText =  picArray[n].caption;
  h2.innerText = picArray[n].title;
  p.innerText = picArray[n].description;
